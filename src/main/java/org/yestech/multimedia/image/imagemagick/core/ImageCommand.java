...
import org.yestech.multimedia.image.imagemagick.process.ErrorConsumer;
import org.yestech.multimedia.image.imagemagick.process.ProcessStarter;
import org.yestech.multimedia.image.imagemagick.process.StandardStream;
...
public class ImageCommand extends ProcessStarter implements ErrorConsumer {
  ...
  */
  ...
  /**
     ...
     @see org.yestech.multimedia.image.im4.process.ErrorConsumer#consumeError(java.io.InputStream)
  */
