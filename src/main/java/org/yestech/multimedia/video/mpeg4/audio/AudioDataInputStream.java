...
/**
 * The <code>AudioDataInputStream</code> realizes the 8khz mono ulaw audio stream 
...
public final class AudioDataInputStream extends PipedInputStream {
	...
	/** <tt>True</tt>, if the audio data stream is closed, <tt>false</tt> otherwise. */
	...
	/** <tt>True</tt>, if any samples haven't been read from the audio data stream, <tt>false</tt> otherwise. */ 
	private boolean firstLoop = true;
	
	/**
	 * Constructs an <code>AudioDataInputStream</code> object and inits it using 
	 * the specified <code>Java1AudioDevice</code> audio device and the source audio stream.      
	 * @param audioDevice the <code>Java1AudioDevice</code> audio device.
	...
	/**
	 * Reads up to <code>len</code> audio samples in the 8 bit ulaw format 
	 * into the buffer <code>b</code> starting from the offset <code>off</code>. 
	...
	*/
	/* 
	 * Constant, set to <tt>true</tt> if you want to turn on the trap as per the MIL-STD 
	...
	/**
	 * Sets the playing status of the audio device (<tt>true</tt>, if the audio device plays the audio).
	...
	/** 
	 * Returns <tt>true</tt>, if any samples haven't been read from the audio data stream. 
	 */	
