...
/*
	// ifndef OLD_PRED_PARAMS
	public static final float PRED_ALPHA = 0.90625;
	public static final float PRED_A     = 0.953125;
	public static final float PRED_B     = 0.953125;
*/
	...
	public static final int LONG_START_WINDOW = 1; 	// TODO verify these constants 
	...
	public static final int MAXBANDS = 16 * NSHORT; /* max number of scale factor bands */
	...
	//
 /*
	public static final int FChans	= 3;	// front channels: left, center, right 
	public static final int FCenter	= 1;	// 1 if decoder has front center channel 
	public static final int SChans	= 0;	// side channels: 
	public static final int BChans	= 2;	// back channels: left surround, right surround 
	public static final int BCenter	= 0;	// 1 if decoder has back center channel 
	public static final int LChans	= 1;	// LFE channels 
	public static final int XChans	= 1;	// scratch space for parsing unused channels   
    
	public static final int ICChans	= 1;	// independently switched coupling channels 
	public static final int DCChans	= 2;	// dependently switched coupling channels 
	public static final int XCChans	= 1;	// scratch space for parsing unused coupling channels 
*/
	public static final int FChans	= 2;	// front channels: left, center, right 
	public static final int FCenter	= 0;	// 1 if decoder has front center channel 
	public static final int SChans	= 0;	// side channels: 
	public static final int BChans	= 0;	// back channels: left surround, right surround 
	public static final int BCenter	= 0;	// 1 if decoder has back center channel 
	public static final int LChans	= 0;	// LFE channels 
	public static final int XChans	= 0;	// scratch space for parsing unused channels   
    
	public static final int ICChans	= 0;	// independently switched coupling channels 
	public static final int DCChans	= 0;	// dependently switched coupling channels 
	public static final int XCChans	= 0;	// scratch space for parsing unused coupling channels 
	...
	public static final int AUTO_SWITCH		= 4;/* AT&T: filter bank detects switching inside */


	/* Required definitions for time to frequency mapping module: */

	/* definitions of the spectral resolutions of the windows */
	public static final int SHORT_BLOCKS_IN_LONG_BLOCK      = 8;       /* no of short blocks replacing one long block */
	public static final int BLOCK_LEN_LONG                  = 1024;    /* #spectral values in long blocks */
	public static final int BLOCK_LEN_SHORT                 = 128;     /* #spectral values in short blocks */
	public static final int BLOCK_LEN_START                 = 1024;    /* #spectral values in start blocks */
	public static final int BLOCK_LEN_STOP                  = 1024;    /* #spectral values in stop blocks */
	...
	public static final char[] debug_options = {'P', 'V', 'G', 'M', 'F', 'S', 'Q', 'I', 'C', 'R', 'T', 'N', 'X'};
}
